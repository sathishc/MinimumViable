<div data-bind="module:{name:'pageController'}" xmlns="http://www.w3.org/1999/html">
    <div data-bind="visible:profileLoaded()==false">
                        ...
                        <div class="tabbable" data-bind="module: {name:'pageController'}">
                            <ul class="nav nav-tabs" id="myTab">
                                <li class="active">
                                    <a data-toggle="tab" href="#page1Inputs"
                                       data-bind="click:function(){selectedPage('Page1');}">Page1</a>
                                </li>
                                <li>
                                    <a data-toggle="tab" href="#page2Inputs"
                                       data-bind="click:function(){selectedPage('Page2');}">Page2</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div id="page2Inputs"
                                     ...
                                     data-bind="visible: isPage1Selected()==false" style="margin-bottom: 0;background-color: transparent;border: 0;">
