<div align="center" data-bind="module:'pageController'">
    <div align="center">
        <div style="padding-bottom: 5px;" data-bind="visible:loggingIn()==false">
        ...
        <div align="center" data-bind="visible:loggingIn()" style="display: none;">
